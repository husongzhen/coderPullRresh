...
//        mOriginalBitmapWidth = ScreenAdaptiveHelper.wp * 10;
//        mOriginalBitmapHeight = mOriginalBitmapWidth;
    ...
    private void drawUltimateBitmap() {
        ...
        mOriginalBitmap = Bitmap.createBitmap(mOriginalBitmap, 0, 0, mOriginalBitmapWidth, mOriginalBitmapHeight, new Matrix(), true);
//        mOriginalBitmap = BitmapScaleUtils.createScaledBitmap(mOriginalBitmap, mOriginalBitmapWidth, mOriginalBitmapHeight, ScalingLogic.FIT);
