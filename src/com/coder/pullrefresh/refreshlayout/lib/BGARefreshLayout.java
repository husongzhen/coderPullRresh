...
package com.coder.pullrefresh.refreshlayout.lib;
...
public class BGARefreshLayout extends LinearLayout {
                        ...
                        .setOnScrollListener(new AbsListView.OnScrollListener() {
                            ...
                            public void onScrollStateChanged(
                                ...
                                if ((scrollState == SCROLL_STATE_IDLE || scrollState == SCROLL_STATE_FLING)
                                        && shouldHandleAbsListViewLoadingMore()) {
                                    Log.i(TAG, "开始加载更多");
                                    beginLoadingMore();
                                }
    ...
    private boolean shouldHandleAbsListViewLoadingMore() {
        if (mIsLoadingMore || mCurrentRefreshStatus == RefreshStatus.REFRESHING
                ...
                || mAbsListView.getAdapter() == null
                || mAbsListView.getAdapter().getCount() == 0) {
            return false;
        }
        ...
        if (mAbsListView.getChildCount() > 0) {
            ...
            lastChildBottom = mAbsListView.getChildAt(
                    mAbsListView.getChildCount() - 1).getBottom();
        }
        return mAbsListView.getLastVisiblePosition() == mAbsListView
                .getAdapter().getCount() - 1
                && lastChildBottom <= mAbsListView.getMeasuredHeight();
    }
    ...
    private boolean shouldHandleLoadingMore() {
        ...
        if (mScrollView != null) {
            ...
            int scrollContentHeight = mScrollView.getMeasuredHeight()
                    - mScrollView.getPaddingTop()
                    - mScrollView.getPaddingBottom();
            int realContentHeight = mScrollView.getChildAt(0)
                    .getMeasuredHeight();
    ...
    private boolean shouldHandleRefresh() {
        ...
        if (mRecyclerView != null) {
            ...
            if (mRecyclerView.getChildCount() > 0) {
                ...
                MarginLayoutParams layoutParams = (MarginLayoutParams) mRecyclerView
            ...
            RecyclerView.LayoutManager manager = mRecyclerView
                    .getLayoutManager();
            if (manager == null) {
                return true;
            }
    ...
    private boolean handleActionMove(MotionEvent event) {
        ...
        if (mCustomHeaderView != null && mIsCustomHeaderViewScrollable) {
            ...
            if (!isWholeHeaderViewCompleteInvisible()
                    || (wholeHeaderDiffY > 0 && shouldHandleRefresh() && !isCustomHeaderViewCompleteVisible())) {
    ...
    private void showLoadingMoreView() {
        ...
        if (mRecyclerView != null) {
            ...
            if (mRecyclerView.getAdapter() != null
                    && mRecyclerView.getAdapter().getItemCount() > 0) {
//                layoutManager.scrollToPosition(mRecyclerView.getAdapter()
//                        .getItemCount());
                mRecyclerView.smoothScrollToPosition(mRecyclerView.getAdapter()
                        .getItemCount());
            }
        }
        if (mAbsListView != null) {
